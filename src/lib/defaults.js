  ...
  webforms: [
    {
      id: 'pig-dailys',
      teamMembers: [],
      name: 'Pig Daily Report',
      description: 'Daily care report for each pig group',
      table: 'pig_dailys',
      allowAddGroup: false,
      sections: [
        {
        ...
        },
        {
          ...
          fields: [
            ...
            {
              id: 'nipple_drinker_moved',
              label: 'Nipple drinker moved?',
              type: 'yes_no',
              required: false,
              system: false,
              enabled: true,
            ...
            {
              id: 'nipple_drinker_working',
              label: 'Nipple drinker working?',
              type: 'yes_no',
              required: false,
              system: false,
              enabled: true,
    ...
    },
    {
      id: 'broiler-dailys',
      teamMembers: [],
      name: 'Broiler Daily Report',
      description: 'Daily care report for broiler batches',
    ...
    },
    {
      id: 'layer-dailys',
      teamMembers: [],
      name: 'Layer Daily Report',
      description: 'Daily care report for layer flocks',
      table: 'layer_dailys',
      allowAddGroup: false,
      sections: [
        {
    ...
    },
    {
      id: 'egg-dailys',
      teamMembers: [],
      name: 'Egg Daily Report',
      description: 'Daily egg collection report',
      table: 'egg_dailys',
      allowAddGroup: false,
      sections: [
        {
