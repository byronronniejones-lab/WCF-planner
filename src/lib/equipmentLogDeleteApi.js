...
//   * delete_equipment_fueling — deletes one equipment_fuelings row and logs
//     record.deleted on the equipment.item entity, atomically.
...
export async function deleteEquipmentFueling(sb, {fuelingId, entityLabel = null, teamMember = null} = {}) {
  const {data, error} = await sb.rpc('delete_equipment_fueling', {
