-- ============================================================================
-- 064_activity_entity_phase2.sql
-- ----------------------------------------------------------------------------
-- Add _activity_can_read resolver branches for:
--   pig.batch            — feeder groups in app_store ppp-feeders-v1
--   cattle.processing    — cattle_processing_batches table
--   sheep.processing     — sheep_processing_batches table
--
-- Preserves all existing entity types and the role/program_access gate
-- from migration 062.
--
-- Client-side: src/lib/activityRegistry.js carries matching entries.
...
BEGIN
  ...
  -- Task entity types: transparency RLS, no program_access check.
  ...
  -- Non-task: existence + program_access. Admin bypasses program_access.
...
-- ============================================================================
-- End of 064_activity_entity_phase2.sql
-- ============================================================================
